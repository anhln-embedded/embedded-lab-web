  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        authorName: article.authorName || topic.author || "Kỹ sư Lab PTIT",
        authorTitle: article.authorTitle || topic.authorTitle || "Mentor Lab Embedded-AIoT",
        authorAvatar: article.authorAvatar || topic.coverImage || "/images/logo.png",
